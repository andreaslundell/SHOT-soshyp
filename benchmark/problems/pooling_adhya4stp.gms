...
e1..    objvar - 5*x38 + 10*x39 + 15*x40 - 9*x41 - 5*x42 + 3*x43 + 18*x44
      ...
      + 5*x73 + 20*x74 + 25*x75 + x76 + 5*x77 =E= 0;

e2..    x38 + x39 + x40 + x41 + x42 =L= 85;

e3..    x43 + x44 + x45 + x46 + x47 =L= 85;

e4..    x48 + x49 + x50 + x51 + x52 =L= 85;

e5..    x53 + x54 + x55 + x56 + x57 =L= 85;

e6..    x58 + x59 + x60 + x61 + x62 =L= 85;

e7..    x63 + x64 + x65 + x66 + x67 =L= 85;

e8..    x68 + x69 + x70 + x71 + x72 =L= 85;

e9..    x73 + x74 + x75 + x76 + x77 =L= 85;

e10..    x38 + x39 + x40 + x41 + x42 + x43 + x44 + x45 + x46 + x47 + x48 + x49
       + x50 + x51 + x52 + x53 + x54 + x55 + x56 + x57 =L= 85;

e11..    x58 + x59 + x60 + x61 + x62 + x63 + x64 + x65 + x66 + x67 + x68 + x69
       + x70 + x71 + x72 + x73 + x74 + x75 + x76 + x77 =L= 85;

e12..    x38 + x43 + x48 + x53 + x58 + x63 + x68 + x73 =L= 15;

e13..    x39 + x44 + x49 + x54 + x59 + x64 + x69 + x74 =L= 25;

e14..    x40 + x45 + x50 + x55 + x60 + x65 + x70 + x75 =L= 10;

e15..    x41 + x46 + x51 + x56 + x61 + x66 + x71 + x76 =L= 20;

e16..    x42 + x47 + x52 + x57 + x62 + x67 + x72 + x77 =L= 15;

e17..  - 0.7*x38 + 0.2*x43 + 0.3*x53 + 0.4*x58 + 0.3*x68 + 0.2*x73 =L= 0;

e18..    0.2*x38 + 0.1*x43 + 0.2*x48 - 0.5*x53 + 0.1*x58 - 0.6*x63 - 0.2*x68
       - 0.0999999999999999*x73 =L= 0;

e19..  - 0.0999999999999999*x38 + 0.3*x43 + 0.3*x53 + 0.2*x58 + 0.1*x68
       - 0.2*x73 =L= 0;

e20..  - 0.7*x38 - 0.0999999999999999*x43 - 0.3*x48 - 0.4*x53 + 0.3*x58
       + 0.3*x63 - 0.2*x68 - 0.0999999999999999*x73 =L= 0;

e21..  - 0.9*x39 - 0.2*x49 + 0.1*x54 + 0.2*x59 - 0.2*x64 + 0.1*x69 =L= 0;
...
e25..  - 0.8*x40 + 0.0999999999999999*x45 - 0.1*x50 + 0.2*x55 + 0.3*x60
       - 0.1*x65 + 0.2*x70 + 0.0999999999999999*x75 =L= 0;
...
e29..  - 0.7*x41 + 0.2*x46 + 0.3*x56 + 0.4*x61 + 0.3*x71 + 0.2*x76 =L= 0;
...
e32..  - 0.6*x41 - 0.2*x51 - 0.3*x56 + 0.4*x61 + 0.4*x66 - 0.1*x71 =L= 0;
...
e37..    x20 + x21 + x22 + x23 =E= 1;

e38..    x24 + x25 + x26 + x27 =E= 1;

e39..    x28 + x29 + x30 + x31 + x32 =E= 1;

e40..    x33 + x34 + x35 + x36 + x37 =E= 1;
