...
e1..  - x1 + objvar =E= -8.79645943005142;
...
e9.. (x2 - x16)*(x2 - x16) + (x3 - x17)*(x3 - x17) =G= 1.96;
...
e14.. (x4 - x14)*(x4 - x14) + (x5 - x15)*(x5 - x15) =G= 1.44;

e15.. (x4 - x16)*(x4 - x16) + (x5 - x17)*(x5 - x17) =G= 1.96;
...
e19.. (x6 - x14)*(x6 - x14) + (x7 - x15)*(x7 - x15) =G= 1.44;

e20.. (x6 - x16)*(x6 - x16) + (x7 - x17)*(x7 - x17) =G= 1.96;

e21.. (x8 - x10)*(x8 - x10) + (x9 - x11)*(x9 - x11) =G= 1;

e22.. (x8 - x12)*(x8 - x12) + (x9 - x13)*(x9 - x13) =G= 1;

e23.. (x8 - x14)*(x8 - x14) + (x9 - x15)*(x9 - x15) =G= 1.44;

e24.. (x8 - x16)*(x8 - x16) + (x9 - x17)*(x9 - x17) =G= 1.96;

e25.. (x10 - x12)*(x10 - x12) + (x11 - x13)*(x11 - x13) =G= 1;

e26.. (x10 - x14)*(x10 - x14) + (x11 - x15)*(x11 - x15) =G= 1.44;

e27.. (x10 - x16)*(x10 - x16) + (x11 - x17)*(x11 - x17) =G= 1.96;

e28.. (x12 - x14)*(x12 - x14) + (x13 - x15)*(x13 - x15) =G= 1.44;

e29.. (x12 - x16)*(x12 - x16) + (x13 - x17)*(x13 - x17) =G= 1.96;

e30.. (x14 - x16)*(x14 - x16) + (x15 - x17)*(x15 - x17) =G= 2.56;
...
x13.lo = 0.5; x13.up = 3.5;
x14.lo = 0.7; x14.up = 7.3;
x15.lo = 0.7; x15.up = 3.3;
x16.lo = 0.9; x16.up = 7.1;
x17.lo = 0.9; x17.up = 3.1;
x18.up = 8;
x19.up = 4;
