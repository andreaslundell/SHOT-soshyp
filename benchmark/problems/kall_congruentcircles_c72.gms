...
e1..  - x1 + objvar =E= -5.49778714378214;
...
e13.. (x4 - x14)*(x4 - x14) + (x5 - x15)*(x5 - x15) =G= 1;
...
e17.. (x6 - x14)*(x6 - x14) + (x7 - x15)*(x7 - x15) =G= 1;

e18.. (x8 - x10)*(x8 - x10) + (x9 - x11)*(x9 - x11) =G= 1;

e19.. (x8 - x12)*(x8 - x12) + (x9 - x13)*(x9 - x13) =G= 1;

e20.. (x8 - x14)*(x8 - x14) + (x9 - x15)*(x9 - x15) =G= 1;

e21.. (x10 - x12)*(x10 - x12) + (x11 - x13)*(x11 - x13) =G= 1;

e22.. (x10 - x14)*(x10 - x14) + (x11 - x15)*(x11 - x15) =G= 1;

e23.. (x12 - x14)*(x12 - x14) + (x13 - x15)*(x13 - x15) =G= 1;
...
x8.lo = 0.5; x8.up = 5.5;
x9.lo = 0.5; x9.up = 1.5;
x10.lo = 0.5; x10.up = 5.5;
x11.lo = 0.5; x11.up = 1.5;
x12.lo = 0.5; x12.up = 5.5;
x13.lo = 0.5; x13.up = 1.5;
x14.lo = 0.5; x14.up = 5.5;
x15.lo = 0.5; x15.up = 1.5;
x16.up = 6;
x17.up = 2;
objvar.lo = 0; objvar.up = 12;
